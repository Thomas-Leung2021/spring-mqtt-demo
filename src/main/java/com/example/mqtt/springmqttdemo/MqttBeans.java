...
public class MqttBeans {
    ...
    // PUBLISHING (Also need MqttGateway.java and MqttController.java)
    @Bean
    ...
    @Bean
    @ServiceActivator(inputChannel = "mqttOutboundChannel") // indicate the method is using/ handling the message
